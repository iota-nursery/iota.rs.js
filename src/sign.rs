...
use iota_sign::iss;
use iota_curl::*;
use iota_curl::simple::*;

use util::c_str_to_static_slice;

#[no_mangle]
pub fn subseed(c_seed: *const c_char, index: usize) -> *const c_char {
    ...
    &out_str.as_bytes()[0] as *const c_char
}

#[no_mangle]
pub fn key(c_subseed: *const c_char) -> *const c_char {
...
#[no_mangle]
pub fn digest_key(c_key: *const c_char) -> *const c_char {
...
#[no_mangle]
pub fn address(c_digest: *const c_char) -> *const c_char {
...
#[no_mangle]
pub fn signature(c_bundle: *const c_char, c_key: *const c_char) -> *const c_char {
    let key_str = unsafe { c_str_to_static_slice(c_key) };
    let key: Trinary = key_str.chars().collect();
...
#[no_mangle]
pub fn digest_bundle_signature(c_bundle: *const c_char, c_signature: *const c_char) -> *const c_char {
